...
//    FILE *fp = fopen("/storage/emulated/0/Android/data/com.your_package_name.demo/files/log/ffmpegDemolog.txt","a+");
    FILE *fp = fopen("/storage/emulated/0/Android/data/com.milanac007.demo.ffmpeg_android_demo/files/files/ffmpegDemolog.txt","a+");

//    FILE *fp = fopen((char *)ptr + "/log/ffmpegDemolog.txt","a+");
